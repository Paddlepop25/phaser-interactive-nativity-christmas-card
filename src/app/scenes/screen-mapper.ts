...
// split the scene into rows and columns (set grid)
export class ScreenMapper { 
  ...
  placeTextAt(x, y, msg: string, opts: any = {}) {
    const text = this.config.scene.add.text(0, 0, msg, 
      {
        fontFamily: 'Mountains of Christmas', //google font imported in styles.css
        fontSize: '8em',
        color: '#00ff00'
      })
  ...
  // helping with object placement and debugging
  drawGrids() {
    // get copy of the graphics context
